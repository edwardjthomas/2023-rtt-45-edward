...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                // this line is saying anything with the URL /employee/** is going require
                // authentication
                ...
                // this is the URL that the login page will submit to with a
                // action="/user/loginpost" method="POST"
                // this controller method is implemented by spring security and you dont have to
                // do anything to use it
                // other than set the method to post and set the action to this URL
                .loginProcessingUrl("/login/loginpost")
                // this URL is where spring security will send the user IF they have not
                // requested a secure URL
                // if they have requested a secure URL spring security will ignore this and send
                // them to the
