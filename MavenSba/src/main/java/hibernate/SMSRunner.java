...
//There’s an @AllArgsConstructor
//And a @NoArgsConstructor
//If you can get this working you’re going to get points
//2 points extra credit if you use id instead of email
